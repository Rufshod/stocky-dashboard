                            ...
                            [
                                dbc.Row(
                                    dbc.Card(
                                        [
                                            html.H2(
                                                "Highest value",
                                                className="h5 mt-3 mx-3 t-3",
                                            ),
                                            html.P(
                                                id="highest-value",
                                                className="h3 mx-2 text-success",
                                            ),
                                        ]
                                ...
                                dbc.Row(
                                    dbc.Card(
                                        [
                                            html.H2(
                                                "Lowest value", className="h5 mt-3 mx-3 t-3"
                                            ),
                                            html.P(
                                                id="lowest-value",
                                                className="h3 mx-2 text-danger",
                                            ),
                                        ]
                                    ),  class_name="mt-5 h-25"
                                ),
                            ], lg= "3", xl = "2", md = "6", sm = "6", xs = "6", class_name= "mt-5 mx-5"
                        ),
                    ]
                ),
